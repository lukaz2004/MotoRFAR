...
private void transmitGroupAlert(AlertHelper.AlertType alertType) {
    ...
    new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(() -> {
        ...
        final com.vagell.kv4pht.data.APRSMessage aprsMessage =
                new com.vagell.kv4pht.data.APRSMessage();
        aprsMessage.type = com.vagell.kv4pht.data.APRSMessage.MESSAGE_TYPE;
        ...
        showSimpleSnackbar(com.vagell.kv4pht.ui.AlertHelper.getSentConfirmation(alertType));
        showScreen(ScreenType.SCREEN_CHAT);
    }, 2000);
}
}