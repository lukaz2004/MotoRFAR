...
import ar.motorfar.app.aprs.parser.Digipeater;
import ar.motorfar.app.aprs.parser.InformationField;
import ar.motorfar.app.aprs.parser.MessagePacket;
import ar.motorfar.app.aprs.parser.Parser;
import ar.motorfar.app.aprs.parser.Position;
import ar.motorfar.app.aprs.parser.PositionField;
import ar.motorfar.app.data.ChannelMemory;
import ar.motorfar.app.firmware.FirmwareUtils;
import ar.motorfar.app.javAX25.ax25.Packet;
...
public class RadioAudioService extends Service {
    ...
    public static final String INTENT_OPEN_CHAT = "ar.motorfar.app.OPEN_CHAT_ACTION";
    public static final String ACTION_STOP_SERVICE = "ar.motorfar.app.STOP_RADIO_SERVICE";
    public static final String ACTION_SERVICE_STOPPING = "ar.motorfar.app.SERVICE_STOPPING";
